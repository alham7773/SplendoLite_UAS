...
*  * **Nama**: Muh suhri Fauzi
* **NIM**: 2304411703
* **Kelas**: 5k GAB 3 RPL

### 2. Tema & Rujukan
* **Tema**: Aplikasi Manajemen Tugas (To-Do List) bernama SplendoLite
* **Aplikasi Rujukan**: Splendo (To-Do List)
* **Link Play Store**: https://play.google.com/store/apps/details?id=com.splendapps.splendo

### 3. Fitur yang Dibuat (Ceklist)
* [x] Autentikasi Login
* [x] Menampilkan Daftar Tugas (List View)
* [x] Menambah Tugas Baru (Add)
* [x] Mengubah Data Tugas (Edit/update tugas)
* [x] Menampilkan halaman profil
...
3. **Halaman Tambah Data (Add)**
4. **Halaman Edit Data/update data**
5. **Halaman profil**
...
1. Clone atau Download ZIP repositori ini dari GitHub.
